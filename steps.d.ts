...
declare namespace CodeceptJS {
  interface SupportObject { I: I, current: any, getStartedView: getStartedView, scheduledAlarmsView: scheduledAlarmsView, newScheduleAlarmView: newScheduleAlarmView }
